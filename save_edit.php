...
include("config.php");
  ...
  $sqlt = "DELETE FROM $db.YoutubePlaylist WHERE PlayListID ='".$_POST['PlayListID']."'" ;
 ...
 // var_dump($postData);
  ...
  curl_setopt_array($ch, array(
    CURLOPT_URL => 'http://youmix.co/api.php/playlist/'.$PlayListID,
                ...
                <div class="col-md-6 col-md-offset-3">
                    <div class="success-message">
                      ...
                      <div class="success-message__content">
                          <a href="player.php?v=<?=$PlayListID;?>&type=Playlist&VideoID=" class="btn btn-submit btn-primary btn-large" style="margin-top:24px;">Play</a>
                      </div>
                    </div>
                </div>
            </div>

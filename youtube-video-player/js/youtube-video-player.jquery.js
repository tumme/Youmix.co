	...
	$.youtube_video = function(el, options){
		...
		base.create_playlist = function(through_pagination, items, count) {
			...
			for(base.info.playlist_i; base.info.playlist_i < base.playlist_count+count; base.info.playlist_i++) {
				...
				// Vertical video
				var $video = $('<div class="yesp-playlist-video" data-playing="0" data-index="'+base.info.playlist_i+'" data-vdo="'+videoId+'"><img src="'+img_src+'" width="200" /><div class="yesp-playlist-overlay"><div class="yesp-playlist-title">'+video.snippet.title+'</div><div class="yesp-playlist-channel">'+video.snippet.channelTitle+'</div></div><div class="yesp-playlist-current"><i class="yesp-icon yesp-icon-play"></i><span>'+base.options.now_playing_text+'</span></div></div>');
				...
				var video_id = video.snippet.videoId;

				if(video_title.length > 45) {
					video_title = video.snippet.title.substring(0, 45) + '...';
				}

				var $video_hp = $('<div class="yesp-hp-video data-playing="0" data-index="'+base.info.playlist_i+'" data-vdo="'+video_id+'"><a href="#" style="width:100%;height:100%;display:block;"><img src="'+img_src+'" width="200" /></a><div class="yesp-hp-overlay"><div class="yesp-hp-title">'+video_title+'</div><div class="yesp-hp-channel">'+video.snippet.channelTitle+'</div></div><div class="yesp-hp-current"><i class="yesp-icon yesp-icon-play"></i><span>'+base.options.now_playing_text+'</span></div></div>');

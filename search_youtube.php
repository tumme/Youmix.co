<?php
    ...
    $videoId = $items["id"]["videoId"];
		$youtube_videos .= '<div class="' . $video_state . '"><img src="' . $thumbnail_url . '"></div> <div class="image_overlay"></div><div class="add_to_cart" style="background:#EC2657;color:#fff;">Add to Playlist</div><div class="view_modal" style="top:125px;"data-toggle="modal" data-target="#videoModal" data-theVideo="http://www.youtube.com/embed/'.$videoId.'">View</div>';	
